...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PROJ_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("58948b4f-47e0-5654-a9ad-f609743f8632"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PROJ", artifacts_toml) for e in artifacts["PROJ"]]
...
if best_platform === nothing
    @debug("Unable to load PROJ; unsupported platform $(triplet(platform_key_abi()))")
else
